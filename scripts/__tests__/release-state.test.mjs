...
test("release cleanup restores version files and preserves unrelated staged and untracked work", () => {
...
`, "release-state-test", root, helper], { env, encoding: "utf8" });
  ...
  assert.equal(existsSync(join(root, "packages/with space/CHANGELOG.md")), false);
